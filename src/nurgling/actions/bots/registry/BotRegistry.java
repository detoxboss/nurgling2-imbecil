...
public class BotRegistry {
    ...
    static {
        ...
        bots.add(new BotDescriptor("lpassistantbot", BotDescriptor.BotType.RESOURCES, "bot.lpassistantbot.title", "bot.lpassistantbot.desc", false, true, LpAssistantBot.class, "lpassistant", false));
        ...
        bots.add(new BotDescriptor("combatreactortool", BotDescriptor.BotType.BATTLE, "Combat Reactor", "Configure and start/stop the combat reactor (auto-defense + manual attack recommender for Quick Barrage/Full Circle/Sting).", false, true, CombatReactorTool.class, "combatreactor", false));

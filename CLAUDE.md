...
| Hafen/upstream integration | `docs/hafen-integration-guide.md`, `docs/fork-sync-guide.md`, `docs/fork-customization-ledger.md`, `docs/fork-maintenance-backlog.md`, `docs/nurgling-modified-files.md` |
